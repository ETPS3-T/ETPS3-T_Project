...
public class AdministrarLugares extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        BtnImgPortada = view.findViewById(R.id.BtnImgPortada);
        BtnCargarFotos = view.findViewById(R.id.BtnCargarFotos);
        BtnGuardarLugar = view.findViewById(R.id.BtnGuardarLugar);
        BtnListaLugar = view.findViewById(R.id.BtnListaLugar);
        GridImgs = view.findViewById(R.id.GridImgs);

        TvImgSeleccionada = view.findViewById(R.id.TvImgSeleccionada);
