...
public class RecyclerViewAdapterMini extends RecyclerView.Adapter<RecyclerViewAdapterMini.ViewHolder>{

    private List<LugaresEntity> listaLugares;
    private InterfaceClickListener selectedItemListener;

    public RecyclerViewAdapterMini(List<LugaresEntity> listaLugares, InterfaceClickListener selectedItemListener) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterMini.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View contactView = inflater.inflate(R.layout.lugaresview_mini, parent, false);
